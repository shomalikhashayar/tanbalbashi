<template>
    <div style="height: calc(100vh);" class="bg-accent text-dark row justify-center items-center">
      ...
      <div class="row" style="width:450px">
        <h2 class="text-h1 no-margin text-center text-weight-900">صفحه مورد نظر پیدا نشد</h2>
        <p class="no-margin text-h6 q-pt-md no-letter-spacing">
          ممکن است صفحه مورد نظر وجود شما وجود نداشته باشد، شاید به آدرس جدیدی منتقل شده است!
        </p>
        <q-btn rounded unelevated to="/" class="q-mt-lg text-body1" color="blue-grey-10">
          بازگشت به صفحه اصلی
        </q-btn>
      </div>
    </div>
